...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Admin Dashboard
                <small>Register Enumerators</small>
            </h1>
            <ol class="breadcrumb">
        ...
        <!-- Main content -->
        <section class="content" style="min-height: 890px" >
        ...
        <!-- Registered users widget -->
            ...
            <div class="col-md-6">
                ...
                <form action="{{ route('register-enumerator') }} " method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group" >
                        ...
                        <input class="form-control" name="headoffice" type="text" id="headoffice">
                    ...
                    <div class="form-group" >
                        ...
                        <input class="form-control" name="reportsto" type="text" id="reportsto">

                    </div>

                    <div class="form-group" >
                        <label for="county">Supervisor Phone Number</label>
                        <input class="form-control" name="supervisor_phone" type="text" id="supervisor_phone">
